...
Messages.user_cert_missing = "No se ha encontrado un certificado " \
    "personal"
Config.instname = "Universidad de Cuenca"
Config.profilename = ""
Config.url = "http://tic.ucuenca.edu.ec"
Config.email = "tu soporte local eduroam®"
Config.title = "eduroam CAT"
Config.server_match = "radius.eduroam.ucuenca.edu.ec"
...
Config.user_realm = "ucuenca.edu.ec"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.eduroam.ucuenca.edu.ec']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
run_installer()
